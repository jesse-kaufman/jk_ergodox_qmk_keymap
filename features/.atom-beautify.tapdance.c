...
void dance_tab_mgmt_finished(qk_tap_dance_state_t *state, void *user_data) {
	...
	case SINGLE_TAP: tap_code16(LGUI(KC_T)); break;
	case SINGLE_HOLD: tap_code16(LGUI(LSFT(KC_T))); break;
	case DOUBLE_TAP: tap_code16(LGUI(KC_W)); break;
	}
}
...
void dance_quote_finished(qk_tap_dance_state_t *state, void *user_data) {
	...
	case DOUBLE_TAP: tap_code16(KC_QUOTE); tap_code16(KC_QUOTE); clear_mods(); tap_code16(KC_LEFT); break;
	case DOUBLE_HOLD: tap_code16(KC_DQUO); tap_code16(KC_DQUO); clear_mods(); tap_code16(KC_LEFT); break;
	}
}
...
void dance_dot_finished(qk_tap_dance_state_t *state, void *user_data) {
	...
	case DOUBLE_TAP: tap_code16(KC_DOT); register_code16(KC_DOT); break;
...
void dance_15_finished(qk_tap_dance_state_t *state, void *user_data) {
	...
	case DOUBLE_TAP: register_code16(MEH(KC_RBRACKET)); break;
...
void dance_15_reset(qk_tap_dance_state_t *state, void *user_data) {
	...
	case DOUBLE_TAP: unregister_code16(MEH(KC_RBRACKET)); break;
...
void dance_16_finished(qk_tap_dance_state_t *state, void *user_data) {
	...
	case DOUBLE_TAP: tap_code16(KC_LBRACKET); tap_code16(KC_RBRACKET); unregister_code16(KC_LSFT); tap_code16(KC_LEFT); break;
	case DOUBLE_SINGLE_TAP: tap_code16(KC_LBRACKET); unregister_code16(KC_LSFT); register_code16(KC_LBRACKET);
	}
}
...
void dance_dquote_finished(qk_tap_dance_state_t *state, void *user_data) {
	...
	case DOUBLE_TAP: tap_code16(KC_DQUO); tap_code16(KC_DQUO); tap_code16(KC_LEFT); break;
...
void dance_18_finished(qk_tap_dance_state_t *state, void *user_data) {
	...
	case DOUBLE_TAP: tap_code16(KC_LPRN); tap_code16(KC_RPRN); tap_code16(KC_LEFT); break;
...
void dance_gteq_finished(qk_tap_dance_state_t *state, void *user_data) {
	...
	case DOUBLE_TAP: tap_code16(KC_RABK); tap_code16(KC_EQUAL); ; break;
...
void dance_gteq_reset(qk_tap_dance_state_t *state, void *user_data) {
	...
	case DOUBLE_TAP: unregister_code16(MEH(KC_DOT)); break;
...
void dance_lteq_finished(qk_tap_dance_state_t *state, void *user_data) {
	...
	case DOUBLE_TAP: tap_code16(KC_LABK); tap_code16(KC_EQUAL); ; break;
...
void dance_lteq_reset(qk_tap_dance_state_t *state, void *user_data) {
	...
	case DOUBLE_TAP: unregister_code16(MEH(KC_COMMA)); break;
