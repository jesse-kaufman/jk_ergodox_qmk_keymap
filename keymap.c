...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_BASE] = LAYOUT_ergodox_pretty(
		...
		_UNDO,			_REDO,			_OSM_CTR,		_OSM_OPT,		_SHFT_TAB,																												OSL(_SYM),		_OSM_RCMD,		KC_DOWN,		KC_UP,			TT(_FN),
	...
	[_SYM] = LAYOUT_ergodox_pretty(
		...
		_______,		_KC_COMMENT,	KC_AT,			KC_HASH,		KC_DLR,			KC_PERC,		_______,												TO(_NUM),		KC_AMPR,		KC_PIPE,		_LBRACKET,		KC_RBRACKET,	XXXXXXX,		_______,
	...
	[_FN] = LAYOUT_ergodox_pretty(
		...
		_______,		XXXXXXX,		KC_BSPACE,		KC_ESCAPE,		XXXXXXX,		XXXXXXX,		_______,												TO(_NUM),		_FORWARD,		KC_PGUP,		KC_UP,			KC_HOME,		KC_HOME,		_PGUP_HOME,
		_______,		XXXXXXX,		LSFT(KC_TAB),	KC_TAB,			XXXXXXX,		XXXXXXX,																				LALT(KC_LEFT),	KC_LEFT,		KC_DOWN,		KC_RIGHT,		KC_RIGHT,		LALT(KC_RIGHT),
		_______,		XXXXXXX,		XXXXXXX,		XXXXXXX,		XXXXXXX,		XXXXXXX,		TO(_BASE),												_______,		_BACK,			KC_PGDOWN,		XXXXXXX,		KC_END,			KC_END,			_PGDN_END,
	...
	[_MOUSE] = LAYOUT_ergodox_pretty(
		...
		XXXXXXX,		XXXXXXX,		XXXXXXX,		KC_MS_WH_UP,	KC_MS_WH_UP,	KC_MS_BTN2,		_______,												_______,		_______,		_______,		_______,		_______,		_______,		_______,
