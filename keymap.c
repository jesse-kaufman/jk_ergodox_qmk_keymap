...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_BASE] = LAYOUT_ergodox_pretty(
		...
		TT(_FN),		KC_Q,			KC_W,			KC_F,			KC_P,			KC_B,			KC_ESC,													_MINIMIZE,		KC_J,			KC_L,			KC_U,			KC_Y,			_PAREN,			OSL(_NUM),
		...
		_UNDO,			_REDO,			KC_LCTL,		KC_LOPT,		KC_LSFT,																												_OSL_SYM,		KC_RCMD,		KC_DOWN,		KC_UP,			TT(_FN),
	...
	[_SYM] = LAYOUT_ergodox_pretty(
		...
		_______, 		_______,		_______,		_______,		OSL(_CODE),																												TO(_BASE),		_______,		_______,		_______,		_______,
	...
	[_MOUSE] = LAYOUT_ergodox_pretty(
		...
		_______,		_______,		_______,		_______,		KC_MS_BTN1,																												TO(_BASE),		_______,		_______,		_______,		_______,
