...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_BASE] = LAYOUT_ergodox_pretty(
		...
		KC_F17,			KC_Q,			KC_W,			KC_E,			_KC_R,			_KC_T,			KC_ESC,													KC_LEAD,		KC_Y,			KC_U,			KC_I,			KC_O,			KC_P,			_KC_COLEMAK,
	...
	[_COLEMAK] = LAYOUT_ergodox_pretty(
		...
		_LAST_APP,		_KC_A,			_KC_S,			KC_D,			_F_FN,			KC_G,																					KC_M,			KC_N,			KC_E,			KC_L,			_QUOTE,			_PGUP_HOME,
		KC_F19,			KC_Z,			_KC_X,			_KC_C,			_KC_V,			KC_B,			TT(_FN),												XXXXXXX,		KC_K,			KC_H,			KC_COMMA,		_DOT,			KC_QUES,		_PGDN_END,
		_UNDO,			_REDO,			_OSM_CTR,		OSL(_CODE),		_OSM_CMD,																												OSL(_SYM),		_OSM_CMD,		KC_DOWN,		KC_UP,			TT(_FN),
																										_ZOOM_OUT_100,	_ZOOM_IN,				_VOL_DOWN,		_VOL_UP,
																														_OSM_SHIFT,				_PLAY,
																						_SHFT_SPACE,	KC_TAB,			_OSM_ALT,				CAPS_WORD,		KC_BSPACE,		_SHFT_ENTER
	...
	[_SYM] = LAYOUT_ergodox_pretty(
		...
		_______,		KC_EXLM,		KC_AT,			KC_HASH,		KC_DLR,			KC_PERC,		_______,												_______,		KC_AMPR,		KC_PIPE,		_LBRACKET,		KC_RBRACKET,	XXXXXXX,		_______,
	...
	[_CODE] = LAYOUT_ergodox_pretty(
		...
		_______,		XXXXXXX,		XXXXXXX,		XXXXXXX,		XXXXXXX,		XXXXXXX,		_______,												_______,		XXXXXXX,		_KC_NIX_HOME,	XXXXXXX,		XXXXXXX,		XXXXXXX,		_______,
