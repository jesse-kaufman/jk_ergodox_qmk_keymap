...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_ergodox_pretty(
        ...
        _FN_KEY,    KC_Z,       KC_X,       KC_C,       KC_D,       _KC_V,      KC_LEAD,                                    CAPS_WORD,  _KC_K,      KC_H,       KC_COMMA,   _DOT,       KC_QUES,    KC_PGDOWN, // NOLINT
        _UNDO,      _REDO,      KC_LCTL,    KC_LOPT,    KC_LCMD,                                                                                    _SYM_KEY,   KC_RCMD,    KC_DOWN,    KC_UP,      _FN_KEY, // NOLINT
                                                                                _ZOOM_OUT,  _ZOOM_IN,       _VOL_DOWN,      _VOL_UP, // NOLINT
                                                                                            KC_ESC,         _PLAY, // NOLINT
                                                                    _SPACE,     KC_LSFT,    _ACTION2,       KC_BSPACE,      KC_LSFT,    _SHFT_ENTER ), // NOLINT
    // SYM layer
    [_SYM] = LAYOUT_ergodox_pretty(
        ...
        TO(_BASE),  ___X___,    KC_AT,      _KC_HASH,   KC_PERC,    KC_CIRC,    _______,                                    _______,    ___X___,    KC_AMPR,    KC_UNDS,    KC_PIPE,    _BRACKET,  TO(_NUM), // NOLINT
        _______,    KC_GRAVE,   KC_SLASH,   _DASH,      _EQUAL,     KC_TILD,                                                            ___X___,    _LPRN,      KC_COLON,   _RPRN,      ___X___,    _______, // NOLINT
        _______,    ___X___,    KC_ASTR,    _BSLASH,    KC_DLR,     KC_PLUS,    _______,                                    _______,    ___X___,    _LTEQ,      KC_SCOLON,  _GTEQ,      ___X___,    _______, // NOLINT
    ...
    [_CODE] = LAYOUT_ergodox_pretty(
        ...
        TO(_BASE),  ___X___,    ___X___,    _COMMENT,   _BEG_CBLOCK,_END_CBLOCK,_______,                                    _______,    ___X___,    KC_PIPE,    KC_LCBR,    ___X___,    _CBRACKET,  TO(_NUM), // NOLINT
        _______,    ___X___,    KC_SLASH,   _SARROW,    _DARROW,    _NIX_HOME,                                                          ___X___,    KC_LBRACKET,___X___,    KC_RBRACKET,___X___,    _______, // NOLINT
        _______,    ___X___,    KC_ASTR,    ___X___,    _UP_DIR,    _CUR_DIR,   _______,                                    _______,    ___X___,    _HTML_OPEN, KC_RCBR,    _HTML_CLOSE,___X___,    _______, // NOLINT
    ...
    [_NUM] = LAYOUT_ergodox_pretty(
        _______,    ___X___,    ___X___,    ___X___,    ___X___,    ___X___,    _______,                                    _______,    ___X___,    ___X___,    ___X___,    ___X___,    ___X___,    _______, // NOLINT
        TO(_BASE),  ___X___,    KC_AT,      ___X___,    KC_PERC,    ___X___,    _______,                                    _______,    ___X___,    KC_7,       KC_8,       KC_9,       KC_EQUAL,   TO(_BASE), // NOLINT
        _______,    ___X___,    KC_SLASH,   ___X___,    KC_EQUAL,   ___X___,                                                            ___X___,    KC_4,       KC_5,       KC_6,       ___X___,    _______, // NOLINT
        _______,    ___X___,    KC_ASTR,    ___X___,    KC_DLR,     KC_PLUS,    _______,                                    _______,    KC_0,       KC_1,       KC_2,       _KC_3,      KC_DOT,     _______, // NOLINT
        _______,    _______,    _______,    _______,    _______,                                                                                    KC_0,       _______,    _______,    _______,    TO(_BASE), // NOLINT
                                                                                _______,    _______,        _______,        _______, // NOLINT
                                                                                            _______,        _______, // NOLINT
                                                                    _______,    _______,    _______,        _______,        _______,    _______ ),// NOLINT
    ...
    [_FN] = LAYOUT_ergodox_pretty(
        _______,    ___X___,    ___X___,    ___X___,    ___X___,    ___X___,    _______,                                    _______,    ___X___,        ___X___,    ___X___,    ___X___,    ___X___,        _______, // NOLINT
        TO(_BASE),  ___X___,    LCMD(KC_W), LCMD(KC_F), MEH(KC_P),  MEH(KC_5),  _______,                                    _______,    MEH(KC_UP),     KC_PGUP,    KC_UP,      ___X___,    KC_HOME,        TO(_NUM), // NOLINT
        _______,    ___X___,    KC_LSFT,    MO(_NUM),   MEH(KC_U),  MEH(KC_6),                                                          LOPT(KC_LEFT),  KC_LEFT,    KC_DOWN,    KC_RIGHT,   LOPT(KC_RIGHT), _______, // NOLINT
        _______,    ___X___,    _FN_X,      MEH(KC_0),  MEH(KC_D),  MEH(KC_E),  _______,                                    _______,    MEH(KC_DOWN),   KC_PGDOWN,  ___X___,    KC_DOT,     KC_END,         _______, // NOLINT
