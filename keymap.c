...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_SYM] = LAYOUT_ergodox_pretty(
	...
	_______,	_UP_DIR,		KC_SLASH,		KC_PLUS,		KC_CIRC,		KC_GRAVE,		_______,												KC_BSLASH,		KC_BSLASH,		_SEMICOLON,		_LTEQ,			_GTEQ,			KC_SLASH,		_______,
				XXXXXXX,    	_______,		_______,		_______,		OSL(_CODE),																				TO(_BASE),		_______,		_______,		_______,		TO(_BASE),
